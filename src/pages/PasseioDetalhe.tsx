    ...
    <main className="min-h-screen bg-background font-sans overflow-x-hidden" data-tour-detail>
      ...
      <section className="pt-24 pb-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          {!hidePrices ? (
             <div className="flex flex-row items-center justify-between gap-3 bg-card border border-primary/10 px-3 sm:px-8 py-1.5 sm:py-6 rounded-2xl sm:rounded-[2rem] shadow-xl h-fit ring-4 ring-primary/5 w-fit max-w-full mx-auto">
               <div className="text-left min-w-0 leading-none">
                 ...
                 <span className="text-3xl sm:text-4xl font-black text-primary block leading-none">
                   {formatPrice(getTourMinPrice(tour))}
                 </span>
                 <span className="text-[9px] font-black uppercase text-muted-foreground block mt-0.5 opacity-60 tracking-tighter shrink-0">
      ...
      <div className="flex flex-col gap-4 px-4 sm:px-6 lg:px-0 lg:block lg:gap-0">
