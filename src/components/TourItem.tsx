      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto space-y-4">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl border border-[#25D366]/30 text-[#25D366] hover:bg-[#25D366]/10 transition-colors text-[11px] font-bold uppercase tracking-wider"
          >
