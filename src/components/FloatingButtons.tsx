    ...
    <div className="fixed right-4 bottom-4 md:right-6 md:bottom-6 z-50 flex flex-col gap-2 md:gap-3 items-end pointer-events-auto">
      ...
      {whatsapp && (
        <button
          ...
          className="whatsapp-ping relative w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#25D366] text-white shadow-[0_0_25px_rgba(37,211,102,0.6)] hover:scale-110 active:scale-95 transition-all flex items-center justify-center group before:absolute before:inset-0 before:rounded-full before:border-2 before:border-[#25D366] before:animate-[ping_3s_cubic-bezier(0,0,0.2,1)_infinite]"
          aria-label="WhatsApp"
        >
          <svg viewBox="0 0 24 24" className="w-8 h-8 md:w-10 md:h-10 relative z-10" fill="currentColor">
